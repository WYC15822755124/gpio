...
public class RedisUtil {
    ...
    /**
     * Hash 模糊查询 key（like ab*）
     *
     * @param hashKey 大key 例如：mqttDataColumn
     * @param pattern 模糊规则 例如：ab*
     * @return 匹配的 hash key-value
     */
    public Map<Object, Object> scanHashKeys(String hashKey, String pattern) {
        Map<Object, Object> resultMap = new HashMap<>();
        // scan 模糊匹配 hash 里的小 key（非阻塞，比 keys 命令安全）
        try {
